import type { InstantWithdrawEvent } from "../decoder.js";
import type { NormalizedRecord } from "../normalizer.js";
import type { EventHandler } from "./types.js";

/**
 * Handles InstantWithdraw events from Sera.
 */
export const InstantWithdrawHandler: EventHandler<InstantWithdrawEvent> = {
  eventName: "InstantWithdraw",
